...
###infested farms in Hawkes Bay
###Initial invasion from HBRC database as of 2021
##################################################
...
################################################################################
###Repeat input of parameters for simulations to permit automatic
###retrieval of result outputs and automatic generation of image file names
################################################################################
