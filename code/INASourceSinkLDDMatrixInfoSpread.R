...
###Moderate erradication prob by probability of identifying all patches on farm
CompleteDetectionProb = 0.25
AnnualErradicationProb = AnnualErradicationProb*CompleteDetectionProb

#############################################################
#############################################################

ResultsDir= paste0(main.dir,"/CrossRegionInvasionLDDmatrixInfoSpread/",ClimateScenarios[cs],"/")
