...
################################
ModelName = paste0("StandardCurrentClim_DetProb","0.9")
if(DoClimateChange == TRUE)
  ModelName = paste0("StandardFutureClim_DetProb","0.9")
...
ModelName = paste0("StandardCurrentClim_DetProbInitialInfo",DetectionProbs[detprob])
if(DoClimateChange == TRUE)
ModelName = paste0("StandardFutureClim_DetProbInitialInfo",DetectionProbs[detprob])
OutputDir = paste0(ResultsDir,ModelName,"/")
dir.create(OutputDir)
Start <- Sys.time()
INApestMeta(
...
################################
InitInfoP = 10/nrow(d)
ModelName = paste0("StandardCurrentClim_DetProbInitInfoP",DetectionProbs[detprob])
if(DoClimateChange == TRUE)
  ModelName = paste0("StandardFutureClim_DetProbInitInfoP",DetectionProbs[detprob])
OutputDir = paste0(ResultsDir,ModelName,"/")
dir.create(OutputDir)
Start <- Sys.time()
INApestMeta(
...
ModelName = paste0("StandardCurrentClim_DetProbExternalInfoProb",DetectionProbs[detprob])
if(DoClimateChange == TRUE)
  ModelName = paste0("StandardFutureClim_DetProbExternalInfoProb",DetectionProbs[detprob])
OutputDir = paste0(ResultsDir,ModelName,"/")
dir.create(OutputDir)
Start <- Sys.time()
INApestMeta(
...
################################
ModelName = paste0("StandardCurrentClim_DetProbExternalInfoProbInitInfoP",DetectionProbs[detprob])
if(DoClimateChange == TRUE)
  ModelName = paste0("StandardFutureClim_DetProbExternalInfoProbInitInfoP",DetectionProbs[detprob])
OutputDir = paste0(ResultsDir,ModelName,"/")
dir.create(OutputDir)
Start <- Sys.time()
INApestMeta(
...
################################
ModelName = paste0("StandardCurrentClim_DetProbOngoingExternalInfo",DetectionProbs[detprob])
if(DoClimateChange == TRUE)
  ModelName = paste0("StandardFutureClim_DetProbOngoingExternalInfo",DetectionProbs[detprob])
OutputDir = paste0(ResultsDir,ModelName,"/")
dir.create(OutputDir)
Start <- Sys.time()
INApestMeta(
...
ModelName = paste0("StandardCurrentClim_DetProbOngoingExternalInfoMatrix",DetectionProbs[detprob])
if(DoClimateChange == TRUE)
  ModelName = paste0("StandardFutureClim_DetProbOngoingExternalInfoMatrix",DetectionProbs[detprob])
OutputDir = paste0(ResultsDir,ModelName,"/")
dir.create(OutputDir)
Start <- Sys.time()
INApestMeta(
