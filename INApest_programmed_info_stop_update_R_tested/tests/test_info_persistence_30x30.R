...
summary_rows <- list(); progress_file <- file.path(bundle_root,'info_persistence_progress.txt'); unlink(progress_file)
...
write.csv(summary_df,file.path(bundle_root,'info_persistence_results.csv'),row.names=FALSE)
writeLines(capture.output(print(summary_df,row.names=FALSE)),file.path(bundle_root,'info_persistence_results.txt'))
