...
model_specs <- model_specs[1:4]
summary_rows <- list(); progress_file <- file.path(bundle_root,'info_persistence_progress_g1.txt'); unlink(progress_file)
...
write.csv(summary_df,file.path(bundle_root,'info_persistence_results_g1.csv'),row.names=FALSE)
writeLines(capture.output(print(summary_df,row.names=FALSE)),file.path(bundle_root,'info_persistence_results_g1.txt'))
