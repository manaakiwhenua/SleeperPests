...
ExternalPathogenStateProb = NULL, #Optional named pathogen-state probabilities for accepted external stage-1 host immigrants; NULL means all susceptible
...
if(UseInfoTriggeredSurveillance) {
  ...
  for (timestep in 1:Ntimesteps) {
    ...
    BackgroundDetectionProbabilityResults_local[,,timestep] <- NodeDetectionProb[, , timestep]
    ...
    if(UseInfoTriggeredSurveillance) {
      InfoTriggeredDetectionProbabilityResults_local[,,timestep] <- NodeInfoTriggeredDetectionProb[,,timestep]
