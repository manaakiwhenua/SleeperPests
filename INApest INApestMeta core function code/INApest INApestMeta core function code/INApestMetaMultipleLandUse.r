###############################################################################
### INApestMetaMultipleLandUse -- node x land-use abundance simulation engine
###
### Subdivides abundance within each spatial node by land-use class. Land uses
### can differ in carrying capacity, propagule production, establishment and
### management, allowing managed areas, weakly managed areas and refugia to be
### represented within the same connected landscape.
###
### Host/pest dynamics are linked to the usual INApest information and response
### processes. Optional pathogen states are tracked within each node x land-use
### unit while remaining reconciled to total host abundance.
###############################################################################
...
# ---------------------------------------------------------------------------
# Run independent stochastic permutations.
# ---------------------------------------------------------------------------
for (perm in 1:Nperm) 
  { 
