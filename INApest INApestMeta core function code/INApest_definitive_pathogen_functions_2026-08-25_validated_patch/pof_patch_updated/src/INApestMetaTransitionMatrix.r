...
###########################################################################
###########################################################################
# Default local stage dynamics with passive- or active-propagule dispersal.
# Users may replace this through the LocalDynamics argument of the main
# function; the default is kept in this same source file for inspection
# and modification.
#
...
#   * transition_sddprob / transition_lddprob optionally move individuals while
#     they progress between stages; missing movement-matrix row mass is export.
