...
Predictors = c("DetectionProb","CommunicationProb","Climate","SpreadReduction","EradicationProb")
source(paste0(ScriptDir,"wrapper.xgb.cv.continuous.R"))

path = paste0(ImageDir,"MultManageGBM/")
dir.create(path)
MaxDepth = 3
Nfolds = 10
Nrounds = 10000
LearningRate = 0.1
Nthread = 50
CV <- xgb.cv.continuous(Data = AllData,Predictors = Predictors,Response=Response,path=path,Nrounds = Nrounds,LearningRate = LearningRate,
                Nthread = Nthread,MaxDepth=MaxDepth,save = TRUE)

saveRDS(CV,paste0(path,"Invasion.xgb.cv.out.rds"))

CVout = readRDS(paste0(path,"Invasion.xgb.cv.out.rds"))
...
ModelFile = paste0(path,"xgb.cv.continuous.rds")
...
Interactions = CVout$Interaction
...
xgb.cv.perspective(cv,Nfolds,CVtrain_x=Xpred,Var1,Var2,path,Response = Response, ResponseName = "Invasion (% of maximum)",Var1Lab = "Spread reduction", Var2Lab = "Eradication")

Var2 = "DetectionProb"
Var1 = "EradicationProb"
xgb.cv.perspective(cv,Nfolds,CVtrain_x=Xpred,Var1,Var2,path,Response = Response,ResponseName = "Invasion (% of maximum)",Var2Lab = "Detection", Var1Lab = "Eradication",theta  = 135)

Var1 = "DetectionProb"
Var2 = "Climate"
xgb.cv.perspective(cv,Nfolds,CVtrain_x=Xpred,Var1,Var2,path,Response = Response,ResponseName = "Invasion (% of maximum)",Var1Lab = "Detection", Var2Lab = "Climate")

Var1 = "DetectionProb"
Var2 = "CommunicationProb"
xgb.cv.perspective(cv,Nfolds,CVtrain_x=Xpred,Var1,Var2,path,Response = Response,ResponseName = "Invasion (% of maximum)",Var1Lab = "Detection", Var2Lab = "Communication",theta = 135)
